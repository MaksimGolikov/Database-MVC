...
namespace Entity.Controllers
{
    public class StatesController : Controller
    {
        ...
        public ActionResult SwitchFrize(int id, string chanel)
        {
            ...
            ((Models.IFrize)deviceList[0]).SwitchFrize();
        ...
        public ActionResult SwitchMode(int id,string chanel)
        {
            IDictionary<int, Models.Devices.Device> deviceList = new SortedDictionary<int, Models.Devices.Device>();
            deviceList = CreateObject(id,chanel);

            ((Models.IMode)deviceList[0]).ChangeMod();
            SaveChange(id,chanel,deviceList);
            deviceList = ChouseDevice(chanel);

            return View("~/Views/Database/Index.cshtml",deviceList);
        }
        public ActionResult Switch(int id, string chanel)
        {
            IDictionary<int, Models.Devices.Device> deviceList =new SortedDictionary<int, Models.Devices.Device>();
            deviceList = CreateObject(id,chanel);

            ((Models.IState)deviceList[0]).Switch();
            SaveChange(id,chanel,deviceList);
            deviceList = ChouseDevice(chanel);
